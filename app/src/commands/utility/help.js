      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          },
          {
            name: "`/predict`",
            value:
              "Users can predict the outcome of the current match. Make a guess for the final score and the first goal scorer of the match. For first scorer, use the names listed in `/players` or just the last name of the player ('Gruezo'). If you don't think there will be a goal, just type 'none'",
            inline: false,
          },
          {
            name: "`/predict-me`",
            value:
              "View your prediction statistics. It will show rank, points, appearances, and other stats.",
            inline: false,
          },
          {
            name: "`/predict-last`",
            value:
              "View the results and statistics for the most recent match. Will also distribute the points based on your prediction",
            inline: false,
          },
          {
            name: "`/predict-top`",
          ...
          },
          {
            name: "`/players`",
            value:
              "Will list the players available for the first goal scorer prediction. Can use the full name on whatever is shown here or just the last name or saying 'none'.",
            inline: false,
          },
          {
            name: "`/predict-help`",
